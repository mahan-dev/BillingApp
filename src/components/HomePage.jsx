        ...
        <section className="homeWrapper">
            ...
            <section className="wrapperContent p-8">
                <section className='home_intro'>
                    ...
                    با قبضتو، مدیریت پرداخت قبوض ساختمان شما آسان‌تر از همیشه خواهد بود. تنها با یک کلیک،
                     قبض‌های مربوط به هزینه‌های مختلف ساختمان را به مستاجرین خود نمایش دهید.
                      این سامانه به شما امکان می‌دهد تا تمامی قبوض را به صورت آنلاین
                      و بدون دردسر مدیریت کنید. با استفاده از قبضتو، پرداخت‌ها به موقع انجام می‌شود
                      و شفافیت مالی بیشتری خواهید داشت.
                       همچنین، قابلیت ارسال یادآوری‌های خودکار برای مستاجرین نیز فراهم شده است. از هر نقطه و
                     در هر زمان، قبض‌های ساختمان خود را به راحتی کنترل کنید. با قبضتو، نگرانی‌های پرداخت قبوض را فراموش کنید 
                     و وقت خود را به امور مهم‌تر اختصاص دهید.
                    </p>
